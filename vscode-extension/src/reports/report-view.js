...
function showReports(context, getConfig) {
  if (activePanel) {
    activePanel.reveal(vscode.ViewColumn.Active);
    activePanel.webview.html = buildHtml(activePanel.webview, context.extensionUri, getConfig());
    return;
  }
  ...
  panel.webview.html = buildHtml(panel.webview, context.extensionUri, getConfig());
  panel.onDidDispose(() => {
    activePanel = null;
  });
...
function buildHtml(webview, extensionUri, config) {
