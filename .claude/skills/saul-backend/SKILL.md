...
allowed-tools:
  - Bash(npm test:*)
  - Bash(node saul-daemon/index.cjs:*)
...
paths:
  ...
  - src/tests/vscode-*.test.ts
---

## Estado atual do daemon

Rotas existentes:
!`grep -n "app\.\(get\|post\|put\|delete\)\|handleRoute\|route(" saul-daemon/index.cjs 2>/dev/null | head -25`
