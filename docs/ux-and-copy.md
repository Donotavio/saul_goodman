...
- **Modo terremoto (limiar configurável, padrão 90)**: body treme, overlay toma a tela com mensagem do Saul, contador regressivo (45s) e CTAs (“Abrir relatório”, “Revisar domínios”, “Ativar alerta sonoro”). A sirene só toca se o usuário consentir e a escolha fica persistida. Ao fechar o overlay ele só volta quando o score continua crítico.
- **CTA**:
